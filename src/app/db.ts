...
export const categories: ICategory[] = [
  {
    ...
    name: 'Front End',
    description: 'Vídeos sobre el mundo del desarrollo Front End',
  ...
  },
  {
    ...
    name: 'Mobile',
    description: 'Contenido que he estado estudiando sobre React Native y Flutter',
  ...
  },
  {
    ...
    name: 'Infraestrutura',
    description: 'Todo lo que estoy aprendiendo sobre Docker y más',
  ...
  },
  {
    ...
    name: 'Data Science',
    description: 'Cosas de R y Python que he estado aprendiendo',
    rgbColor: 'rgb(156, 211, 59)',
    isBanner: false,
  },
  {
    ...
    name: 'Design & UX',
    description: 'Herramientas y técnicas que estudio sobre UX y Diseño',
  ...
  },
  {
    ...
    description: 'Cómo mantener contento al equipo y mucho más',
...
export const videos: IVideo[] = [
  ...
  {
    title:
      'Aliados en la Transformación Digital: Alura Latam y No Country',
    videoUrl: 'https://www.youtube.com/watch?v=te6lNxd4rXA',
    imageUrl: '',
    category: 'Front End',
    description:
      'Entiende qué es la Transformación Digital, qué caminos evitar y cuál debe ser tu objetivo para empezar a realizar una transformación digital en tu empresa.',
  },
  {
    title: 'que es React JS? #HipstersPontoTube',
    videoUrl: '',
    imageUrl: '',
    category: 'Front End',
    description:
      'Afinal, o ¿Qué es reaccionar JS? En este vídeo Vanessa Tonini y Mario Souto te lo explican hablando de cómo surgió esta herramienta, para qué sirve, cuáles son sus aplicaciones y relación con otras herramientas y cómo empezar a trabajar con ella.',
  },
  /*{
